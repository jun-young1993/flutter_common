...
class _$UserRewardImpl extends _UserReward {
  ...
  @override
  String toString() {
    return 'UserReward(id: $id, userId: $userId, rewardType: $rewardType, date: $date, usageCount: $usageCount, totalPointsEarned: $totalPointsEarned, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, rewardType, date,
      usageCount, totalPointsEarned, isActive, createdAt, updatedAt);
...
abstract class _UserReward extends UserReward {
  const factory _UserReward(
      ...
      required final DateTime updatedAt}) = _$UserRewardImpl;
